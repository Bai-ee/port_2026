...
3. `../../company-brain/DOWNSTREAM_CONTEXT_USAGE.md` — how Client Brain defaults and feedback promotion interact with this card.
4. `../../company-brain/CLIENT_BRAIN_DECISION_ENGINE.md` — decision/default/override model behind Brain-seeded card settings.
