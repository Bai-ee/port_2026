...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars "^|^SITE_CLONE_SHARED_SECRET=${SITE_CLONE_SHARED_SECRET}|FIREBASE_ADMIN_PROJECT_ID=${FIREBASE_ADMIN_PROJECT_ID}|FIREBASE_ADMIN_CLIENT_EMAIL=${FIREBASE_ADMIN_CLIENT_EMAIL}|FIREBASE_ADMIN_PRIVATE_KEY=${FIREBASE_ADMIN_PRIVATE_KEY}|FIREBASE_ADMIN_STORAGE_BUCKET=${FIREBASE_ADMIN_STORAGE_BUCKET:-}|VERCEL_AUTH_TOKEN=${VERCEL_AUTH_TOKEN:-}|VERCEL_TEAM_ID=${VERCEL_TEAM_ID:-}"
