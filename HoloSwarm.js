...
const LINE1 = 'AGENTIC';
const LINE2 = 'AUTOMATION';
const FULL  = LINE1 + LINE2; // 17 chars

export class HoloSwarm {
  ...
  animate() {
    ...
    const charCount = FULL.length; // 17
    ...
    for (let i = 0; i < count; i++) {
      ...
      // Helix background position (orbits around each character's column)
