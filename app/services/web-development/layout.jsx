  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([serviceSchema, breadcrumbSchema([{ name: 'Home', path: '/' }, { name: 'Web Development', path: '/services/web-development' }], SITE_URL)]) }}
      />
      {children}
    </>
  );
