...
const GLYPHS = {
  ' ': 0,                                                        // ..... ..... ..... ..... .....
  '&': 8  | (20 << 5) | (12 << 10) | (21 << 15) | (13 << 20),  // .X... X.X.. .XX.. X.X.X .XX.X
  ...
  G: 14  | (16 << 5) | (19 << 10) | (17 << 15) | (14 << 20),  // .XXX. X.... X..XX X...X .XXX.
  ...
  P: 30  | (17 << 5) | (30 << 10) | (16 << 15) | (16 << 20),  // XXXX. X...X XXXX. X.... X....
  ...
  U: 17  | (17 << 5) | (17 << 10) | (17 << 15) | (14 << 20),  // X...X X...X X...X X...X .XXX.
  V: 17  | (17 << 5) | (17 << 10) | (10 << 15) | (4  << 20),  // X...X X...X X...X .X.X. ..X..
};

const LINE1 = 'DESIGN &';
const LINE2 = 'DEVELOPMENT';
const FULL  = LINE1 + LINE2; // 19 chars

export class ProductSwarm {
  ...
  animate() {
    ...
    const charCount  = FULL.length; // 27
